...
import { 
  ...
  Clock, CheckCircle2, Search, Terminal, FileText, Headphones
} from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-5 border-l-4 border-green-500 flex items-center justify-between">
          <div>
      ...
      <Card className="p-4">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <select 
            ...
            className="px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
           ...
           {/* Destinatário Fixo */}
           <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-100 dark:border-blue-800 flex items-center">
              <div className="p-2 bg-blue-100 dark:bg-blue-800 rounded-full mr-3">
                 <Terminal className="w-5 h-5 text-blue-700 dark:text-blue-300" />
              </div>
              <div>
                 <span className="text-xs text-blue-600 dark:text-blue-400 font-bold uppercase block">Destinatário</span>
                 <span className="text-sm font-medium text-blue-900 dark:text-blue-100">Suporte Técnico ProBPA - GAX Tecnologia</span>
              </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                 ...
                 <textarea 
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none resize-none h-32"
