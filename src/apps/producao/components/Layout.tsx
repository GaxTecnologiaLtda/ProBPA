                ...
                <div className="p-4 border-t border-gray-100 dark:border-gray-700/50">
                    <div className="mb-4 px-2 flex justify-center">
                        <button
                            ...
                            className={cn(
                                "text-xs font-mono flex items-center gap-2 transition-all px-3 py-1.5 rounded-full border",
                                hasNewVersion
                                    ? "bg-medical-50 border-medical-200 text-medical-700 hover:bg-medical-100 dark:bg-medical-900/30 dark:border-medical-800 dark:text-medical-400 dark:hover:bg-medical-900/50 shadow-sm animate-pulse"
                        ...
                        >
                            ...
                            {hasNewVersion && (
                                <span className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-wider">Ver Novidades</span>
                                </span>
                            )}
                        </button>
                    </div>
