...
SELECT
    ...
    cid.dt_atualizado AS data_atualizacao,
    cid.dt_ultima_ficha AS data_ultima_ficha,
    cid.no_mae AS nome_mae,
    cid.no_sexo AS sexo,
    cid.nu_micro_area AS micro_area,
    cid.ds_logradouro AS logradouro,
    cid.nu_numero AS numero,
    cid.ds_complemento AS complemento,
    cid.no_bairro AS bairro,
    cid.ds_cep AS cep,
    cid.nu_telefone_celular AS telefone_celular,
    cid.nu_telefone_contato AS telefone_contato,
    dim_eq.nu_ine AS ine,
    dim_eq.no_equipe AS nome_equipe,
    dim_us.nu_cnes AS cnes,
    dim_us.no_unidade_saude AS nome_unidade_saude,
    NULL AS nome_profissional_vinc
FROM tb_cidadao cid
