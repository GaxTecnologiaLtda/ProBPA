...
**Regra:** Somente as CBOs apresentadas na [Tabela 3 \- CBOs que podem registrar ficha de atendimento individual](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/regras/cbo.html#ficha-de-atendimento-individual) podem ser adicionadas no campo CBO do profissional principal.
...
**Referência:** [FichaAtendimentoIndividualChild](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#fichaatendimentoindividualchild).
...
* CNS validado de acordo com o [algoritmo de validação](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/regras/algoritmo_CNS.html);  
* Não pode ser preenchido se o campo [cpfCidadao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#24-cpfcidadao) for preenchido.
...
**Referência:** [medicoes](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#medicoes).
...
**Referência:** [AleitamentoMaterno](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/referencias/dicionario.html#aleitamentomaterno).
...
* Não pode ser preenchido quando [Sexo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#5-sexo) \= 0 (masculino);  
* Não pode ser superior à [dataAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/header-transport.html#5-dataatendimento).
...
**Referência:** [Exames](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#exame).
...
**Referência:** [profissionalFinalizadorObservacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#profissionalfinalizadorobservacao).
...
**Referência:** [eMulti](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/referencias/dicionario.html#emulti).
...
**Referência:** [CondutaEncaminhamento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/referencias/dicionario.html#condutaencaminhamento).
...
**Regra:** Não pode ser preenchido quando [Sexo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#5-sexo) \= 0 (masculino).
...
**Referência:** [racionalidadeSaude](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/referencias/dicionario.html#racionalidadesaude).
...
* Não pode ser posterior à [dataHoraFinalAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#23-datahorafinalatendimento) e à data atual.
...
* Não pode ser anterior à [dataHoraInicialAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#22-datahorainicialatendimento);  
...
* Não pode ser preenchido se o campo [cnsCidadao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-cnscidadao) for preenchido.
...
**Referência:** [medicamentos](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#medicamentos).
...
* Não pode ter itens duplicados na lista. Serão considerados duplicados os itens que tiverem a mesma [especialidade](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-especialidade) e [hipoteseDiagnosticoCID10](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-hipotesediagnosticocid10) ou a mesma [especialidade](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-especialidade) e [hipoteseDiagnosticoCIAP2](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-hipotesediagnosticociap2);  
* Todos os encaminhamentos devem ser preenchidos somente com CID10 ou com CIAP2, de acordo com a [Tabela 3 \- CBOs que podem registrar ficha de atendimento individual](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/regras/cbo.html#ficha-de-atendimento-individual);  
* Ao preencher este grupo, é obrigatório o preenchimento do campo [condutas](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#17-condutas) com o valor 4 \- Encaminhamento para serviço especializado.

**Referência:** [encaminhamentos](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#encaminhamentos).
...
**Referência:** [resultadosExames](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#resultadosexames).
...
**Referência:** [problemacondicao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#problemacondicao).
...
**Referência:** [ivcf](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#ivcf).
...
**Referência:** [SolicitacoesOci](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#solicitacoesoci).
...
* [ListaExames](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#listaexames).
...
* Não é permitido o preenchimento caso seja informado um Código AB no campo [ciap](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-ciap);  
* Se torna obrigatório caso preenchido [uuidEvolucaoProblema](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-uuidevolucaoproblema), [coSequencialEvolucao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-cosequencialevolucao) ou [situacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-situacao).
...
* Não é permitido o preenchimento caso seja informado um Código AB no campo [ciap](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-ciap);  
* Se torna obrigatório caso preenchido [uuidEvolucaoProblema](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-uuidevolucaoproblema), [uuidProblema](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-uuidproblema) ou [situacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-situacao).
...
* Pode ser preenchido com Código AB da [ListaCiapCondicaoAvaliada](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#listaciapcondicaoavaliada);  
...
* Se torna obrigatório caso o campo [cid10](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#5-cid10) não seja preenchido.
...
* Se torna obrigatório caso o campo [ciap](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-ciap) não seja preenchido.
...
* Quando a [ciap](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-ciap) informada for "GRAVIDEZ \- W78" não é permitido preencher a situação com o valor "1 \- Latente";  
* Não é permitido o preenchimento caso seja informado um Código AB no campo [ciap](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-ciap);  
* Apenas valores de 0 a 2;  
* Se torna obrigatório caso preenchido [uuidEvolucaoProblema](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-uuidevolucaoproblema), [uuidProblema](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-uuidproblema) ou [coSequencialEvolucao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-cosequencialevolucao).
...
* Deve ser igual ou posterior a [dataNascimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-datanascimento);  
...
* Se torna obrigatório quando o campo [situacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-situacao) possuir o valor "2 \- Resolvido";  
* Deve ser igual ou posterior a [dataNascimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-datanascimento);  
* Deve ser anterior ou igual [dataAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/header-transport.html#5-dataatendimento);  
* Deve ser posterior ou igual a [dataInicioProblema](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#7-datainicioproblema);  
* Não é permitido o preenchimento caso seja informado um Código AB no campo [ciap](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-ciap).
...
**Regra:** Este campo só pode ser marcado como "Verdadeiro" caso o campo [usoContinuo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#5-usocontinuo) estiver marcado com a opção "Falso".
...
**Regra:** Este campo só pode ser marcado como "Verdadeiro" caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado com a opção "Falso".
...
* Não pode ser preenchido caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado como "Verdadeiro";  
* Caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado como "Falso", este campo é de preenchimento obrigatório.
...
* Não pode ser preenchido caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado como "Verdadeiro";  
* Se o campo [doseFrequenciaTipo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-dosefrequenciatipo) \= 1 \- Turno, então deve ser preenchido com a descrição do turno conforme essa [tabela](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/referencias/dicionario.html#turno), complementando a informação com o preenchimento dos campos [doseFrequenciaQuantidade](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#8-dosefrequenciaquantidade) e [doseFrequenciaUnidadeMedida](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#9-dosefrequenciaunidademedida);  
* Se o campo [doseFrequenciaTipo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-dosefrequenciatipo) \= 2 \- Frequência, então deve ser preenchido com o **número de vezes** que a dose deverá ser administrada, complementando a informação com o preenchimento dos campos [doseFrequenciaQuantidade](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#8-dosefrequenciaquantidade) e [doseFrequenciaUnidadeMedida](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#9-dosefrequenciaunidademedida);  
* Se o campo [doseFrequenciaTipo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-dosefrequenciatipo) \= 3 \- Intervalo, então deve ser preenchido com o **intervalo de horas** que a dose deverá ser administrada.
...
* Não pode ser preenchido caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado como "Verdadeiro";  
* Não pode ser preenchido caso o campo [doseFrequenciaTipo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-dosefrequenciatipo) \= 3 \- Intervalo;  
* É de preenchimento obrigatório caso o campo [doseFrequenciaTipo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#6-dosefrequenciatipo) for 1 \- Turno ou 2 \- Frequência.
...
* Não pode ser preenchido caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado como "Verdadeiro";  
* Não pode ser preenchido caso o campo [duracaoTratamentoMedida](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#12-duracaotratamentomedida) \= 4 \- Indeterminado;  
* O valor deste campo deve ser maior que o valor do campo [doseFrequenciaQuantidade](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#8-dosefrequenciaquantidade), respeitando as devidas unidades de medidas.
...
**Regra:** Não pode ser preenchido caso o campo [doseUnica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-doseunica) estiver marcado como "Verdadeiro".
...
**Referência:** [especialidadeEncaminhamentoAtendimentoIndividual](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#especialidadeencaminhamentoatendimentoindividual).
...
* Este campo só poderá ser preenchido caso o profissional for habilitado a informar CID10 conforme apresentado na tabela [Tabela 3 \- CBOs que podem registrar ficha de atendimento individual](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/regras/cbo.html#ficha-de-atendimento-individual);  
* Deve ser preenchida somente CID10 permitida para o [Sexo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#5-sexo) do cidadão;  
* Não pode ser preenchido se o campo [hipoteseDiagnosticoCIAP2](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-hipotesediagnosticociap2) for preenchido;  
* Este campo é de preenchimento obrigatório apenas se o campo [hipoteseDiagnosticoCIAP2](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-hipotesediagnosticociap2) não estiver preenchido.
...
* Este campo só deverá ser preenchido caso o profissional **não** for habilitado a informar CID10 conforme apresentado na tabela [Tabela 3 \- CBOs que podem registrar ficha de atendimento individual](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/regras/cbo.html#ficha-de-atendimento-individual);  
* Deve ser preenchida somente CIAP2 permitida para o [Sexo](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#5-sexo) do cidadão;  
* Deve conter somente CIAP2 que possuem relação com uma CID10, conforme listado na planilha [CIAP2 x CID10 mais frequentes](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/referencias/relacao_ciap_cid.html);  
* Não pode ser preenchido se o campo [hipoteseDiagnosticoCID10](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-hipotesediagnosticocid10) for preenchido;  
* Este campo é de preenchimento obrigatório apenas se o campo [hipoteseDiagnosticoCID10](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-hipotesediagnosticocid10) não estiver preenchido.
...
* Não pode ser posterior à [dataHoraInicialAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#22-datahorainicialatendimento);  
* Não pode ser anterior à [dataNascimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-datanascimento).
...
* Não pode ser posterior à [dataHoraInicialAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#22-datahorainicialatendimento);  
* Não pode ser anterior à [dataSolicitacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#2-datasolicitacao);  
* Não pode ser anterior à [dataNascimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-datanascimento).
...
* Não pode ser posterior à [dataHoraInicialAtendimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#22-datahorainicialatendimento);  
* Não pode ser anterior à [dataRealizacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-datarealizacao);  
* Não pode ser anterior à [dataNascimento](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-datanascimento).
...
**Referência:** [resultadoExame](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#resultadoexame).
...
Refere-se ao resultado do exame propriamente dito e está relacionado com a informação do campo [tipoResultado](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-tiporesultado).
...
* Se o campo [tipoResultado](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-tiporesultado) for igual a 1 \- Valor e o valor do campo [exame](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#1-exame) for:  
...
* O campo [profissionalFinalizadorObservacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#profissionalfinalizadorobservacao) é opcional, mesmo colocando **true** no campo [ficouEmObservacao](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#15-ficouemobservacao).
...
* Caso este campo seja preenchido, torna-se obrigatório o preenchimento do campo [pressaoArterialDiastolica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#4-pressaoarterialdiastolica).  
...
* Caso este campo seja preenchido, torna-se obrigatório o preenchimento do campo [pressaoArterialSistolica](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#3-pressaoarterialsistolica).  
* Valor mínimo 0 e máximo 999;
...
* Caso este campo seja preenchido, torna-se obrigatório o preenchimento do campo [tipoGlicemiaCapilar](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#10-tipoglicemiacapilar).
...
* Caso este campo seja preenchido, torna-se obrigatório o preenchimento do campo [glicemiaCapilar](https://integracao.esusaps.bridge.ufsc.tech/ledi/documentacao/estrutura_arquivos/dicionario-fai.html#9-glicemiacapilar).
